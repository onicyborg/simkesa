...
<div class="d-flex flex-wrap justify-content-between align-items-center mb-5">
    <h3 class="fw-bold mb-0">Laporan Kehadiran (Guru)</h3>
</div>

<div class="card mb-6">
    <div class="card-body">
        <form method="GET" action="{{ route('teacher.reports.attendance') }}" class="row g-4 align-items-end" id="report-filter-form">
            <div class="col-md-3">
            ...
            <div class="col-md-3 d-flex gap-3">
                ...
                <a href="{{ route('teacher.reports.attendance') }}" class="btn btn-light">Reset</a>
            </div>
        </form>
    </div>
</div>
    ...
    <div class="card-body">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div class="d-flex gap-2">
                <a class="btn btn-success" href="{{ route('teacher.reports.attendance.export_excel', request()->query()) }}"><i class="bi bi-file-earmark-excel me-2"></i>Export Excel</a>
            </div>
        </div>
